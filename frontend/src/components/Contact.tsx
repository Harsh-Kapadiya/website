...
const fallbackSocials: SocialLink[] = [
  { id: "1", platform: "X", url: "https://x.com/Harsh2021800" },
  {
    id: "2",
    platform: "LinkedIn",
    url: "https://www.linkedin.com/in/harsh-kapadiya-0a25b1325/?isSelfProfile=true",
  },
  {
    id: "3",
    platform: "LeetCode",
    url: "https://leetcode.com/u/Harsh_kapadiya/",
  },
  { id: "4", platform: "GitHub", url: "https://github.com/Harsh-Kapadiya" },
  {
    id: "5",
    platform: "Instagram",
    url: "https://www.instagram.com/harsh._kapadiya/",
  },
];
...
export function Contact() {
  ...
  const { data: socials } = useTable<SocialLink>(
    "social_links",
    fallbackSocials,
  );
  ...
  return (
    <section
      id="contact"
      className="bg-[#0a0a0a] px-8 md:px-12 py-32 border-t border-white/5"
    >
          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  label: "Location",
                  value: get("contact", "location", "Haryana, India"),
                },
                {
                  label: "Availability",
                  value: get("contact", "availability", "Open to projects"),
                },
              ].map((item) => (
                <div
                  key={item.label}
                  className="flex justify-between items-center py-5 border-b border-white/8"
                >
                  <span
                ...
                {[
                  {
                    ...
                    key: "name",
                    type: "text",
                    placeholder: "Kindly enter you full name",
                  },
                  {
                    label: "Email address",
                    key: "email",
