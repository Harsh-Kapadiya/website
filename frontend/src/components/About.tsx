            ...
            >
              ...
              <div>
                ...
                <p className="text-white/35" style={{ fontSize: '0.8rem' }}>
                  {get('about', 'title_location', 'Designer & Developer · Haryana, India')}
                </p>
              </div>
            </motion.div>
          </div>
